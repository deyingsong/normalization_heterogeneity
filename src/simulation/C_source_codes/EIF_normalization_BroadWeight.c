...
// Broad weight variant: per-connection weights Jrf/Jrr supplied
// Signature preserved: [s, Isyn_record, v_record] = EIF1DRFfastslowSynAtttSpatRec_BroadWeight(sx, Wrf, Wrr, Jrf, Jrr, params)
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    // Jrf, Jrr as column vectors (double)
